...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "hero.location": "Comarca de la Sidra. Asturias.",
    "hero.description": "Tu casa rural con encanto en el concejo de Cabranes. Rehabilitada en 2023, nuestra casa ofrece un alojamiento íntimo para familias y grupos, perfecto para escapadas rurales y vacaciones en Asturias.",
    ...
    "services.bedrooms.description": "Dormitorio 1: Cama King size. Dormitorio 2: Cama de matrimonio. Dormitorio 3: Litera con camas individuales. Ropa de cama incluida.",
    ...
    "rules.trash.description": "La aldea no dispone de servicio de recogida de basura. Se ruega llevar los residuos que se generen durante la estancia y depositarlos por cuenta propia en los contenedores del pueblo más cercano (Villaviciosa, a 7 km).",
  ...
  en: {
    ...
    "hero.title": "La Cabaña de",
    "hero.titleAccent": "la Lechuza",
    "hero.location": "Cider Region. Asturias.",
    "hero.description": "Your charming rural house in the municipality of Cabranes. Renovated in 2023, our cottage offers intimate accommodation for families and groups, perfect for rural getaways and holidays in Asturias.",
    ...
    "services.bedrooms.description": "Bedroom 1: King size bed. Bedroom 2: Double bed. Bedroom 3: Bunk bed with single beds. Bed linen included.",
    ...
    "rules.trash.description": "The village doesn't have garbage collection service. Please take any waste generated during your stay and dispose of it yourself at the containers in the nearest town (Villaviciosa, 7 km away).",
