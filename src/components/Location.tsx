...
const Location = () => {
  ...
  return <section id="ubicacion" aria-label={language === "es" ? "Ubicación de la casa rural en Cabranes, Asturias" : "Rural house location in Cabranes, Asturias"} className="py-28 bg-background" itemScope itemType="https://schema.org/Place">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            <div className="flex items-start gap-4 mb-8" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
            ...
            <div className="mb-8 p-6 bg-primary/5 rounded-lg border border-primary/20">
              ...
              <div className="grid gap-4">
                {highlightedDistances.map(item => <a key={item.name} href={item.link} target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-3 bg-background rounded-lg hover:shadow-md transition-all duration-300 group" aria-label={`${item.name} - ${item.time} ${language === "es" ? "en coche" : "by car"}`}>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {nearbyPlaces.map(place => <a key={place.name} href={place.link} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-lg hover:bg-muted transition-colors group">
          ...
          <div className="space-y-4">
            <div className="aspect-square lg:aspect-[4/5] rounded-lg overflow-hidden card-shadow" itemProp="hasMap" itemScope itemType="https://schema.org/Map">
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5787.6744!2d-5.4169!3d43.4083!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd368b5d1c8b8b8b%3A0x0!2sLa%20Roza%2C%20Cabranes%2C%20Asturias!5e0!3m2!1ses!2ses!4v1699876543210" width="100%" height="100%" style={{
              border: 0
            }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title={language === "es" ? "Mapa de ubicación de La Cabaña de la Lechuza en La Roza, Cabranes" : "Location map of La Cabaña de la Lechuza in La Roza, Cabranes"} itemProp="url" />
            </div>
            <a href="https://maps.app.goo.gl/RAUYH5vjUNvub4Nn9" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 py-3 px-6 bg-primary text-primary-foreground rounded-lg font-body text-sm font-medium hover:bg-primary/90 transition-colors">
