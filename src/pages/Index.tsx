...
const Index = () => {
  ...
  // JSON-LD structured data - VacationRental (consolidated, compliant with Google)
  const jsonLd = {
    ...
    "review": [
      {
        ...
        "reviewBody": language === "es" ? "Casa muy bonita y renovada. En un lugar tranquilo y perfecto para relajarse." : "A very beautiful and renovated house. In a quiet place, perfect for relaxing.",
      ...
      },
      {
        ...
        "reviewBody": language === "es" ? "Un sitio muy bonito, está muy cuidado. Se nota que tiene cariño." : "A very beautiful place, very well maintained.",
        "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5", "worstRating": "1" }
      },
      {
        "@type": "Review",
        ...
        "reviewBody": language === "es" ? "Perfecto para familias que buscan desconectar y disfrutar de la naturaleza." : "Perfect for families looking to disconnect and enjoy nature.",
        "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5", "worstRating": "1" }
      }
    ],
    "sameAs": [
